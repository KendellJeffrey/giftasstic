...
$(document).ready(function(){
    ...
    $("#add-movie").on('click', function(event) {
        ...
        var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + myMovie + "&api_key=2lAj4yexlAt2PET5OG0M2Lsx29Kel7ip&limit&limit=12";  
...
// //     gets text from the input
//     var myMovie = $("#movie-input").val().trim();
...
//                 var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + b + "&api_key=2lAj4yexlAt2PET5OG0M2Lsx29Kel7ip&limit=12";  
